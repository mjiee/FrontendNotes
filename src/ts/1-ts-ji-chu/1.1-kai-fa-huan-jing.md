...
首先需要[安装node环境](../../js/1-js-kai-fa-huan-jing/1.1-kai-fa-huan-jing.md)，然后安装TS命令行工具：
...
配置TS开发ide参考：[vim开发IDE](https://jieem.gitbook.io/linux/linux/2-bian-ji-qi/2.3-vim-ka-fa-ide)
...
然后安装依赖，开始构建项目。初始化中产生的package.json是[项目配置文件](../../js/1-js-kai-fa-huan-jing/1.4-js-shi-yong.md)。而tsconfig.json是TypeScript配置文件，其结构如下：
