...
class NewPage extends StatelessWidget { // 下一页
  NewPage({Key? key, required this.txt}) : super(key: key);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: { // 路由表一个Map<String, WidgetBuider>类型
...
class HomeWidget extends StatelessWidget {
  ...
  onPressed: () {
    ...
    // Navigator.of(context).pushNamed('aa', arguments: 'hi');  // 与上一行等价
  ...
},}
